...
global $avitore_redux_demo; 
$b=$avitore_redux_demo['main-color-1'];
$rgba = hex2rgb($b);  
?>
.top_menu .left_side p a{
  color: <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>;
}
.top_menu .right_side .list li:hover a {
  color: <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>;
}
.main_menu .navbar.navbar-expand-lg .navbar-nav li.submenu .dropdown-menu li:hover a {
  background: <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>;
}

.main_btn {
  border: 1px solid <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>;
   background-image: linear-gradient(30deg, <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?> 50%, transparent 50%);
}
.main_btn:hover {
  color: <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>;
  border-color: <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>!important;
}
...
.room_slider .owl-prev:hover, .room_slider .owl-next:hover {
  background: <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>;
      border-color: <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>;
}
...
.input-group-append .submit_btn:hover, .touch_inner .drop_message .contact_us_form .form-group .submit_btn:hover, .drop_query .submit_btn:hover, #review_form_wrapper .comment-form .form-submit .submit:hover, .contact_us_form .form-group .submit_btn:hover {
  color: <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>!important;
}
.footer_widgets_area .input-group-append .submit_btn {
      border: 1px solid <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>!important;
      background-image: linear-gradient(30deg, <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?> 50%, transparent 50%)!important;
}
...
.facilities_room .faci_item_inner .faci_r_item .faci_r_item_box {
      border-bottom: 4px solid <?php echo esc_attr($avitore_redux_demo['main-color-1']); ?>;
}
