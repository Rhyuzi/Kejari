            ...
            <div class="header-navigation-area three-layers-header">
                ...
                <ul class="social-list">
                    ...
                    <?php if(isset($avitore_redux_demo['header_link_facebook'])){?>
                        ...
                        <li><a href="<?php echo esc_url($avitore_redux_demo['header_link_facebook']);?>"><i class="fa fa-facebook"></i></a></li>

                    <?php } ?> 

                    <?php if(isset($avitore_redux_demo['header_link_twitter'])){?>

                        <li><a href="<?php echo esc_url($avitore_redux_demo['header_link_twitter']);?>"><i class="fa fa-twitter"></i></a></li>

                    <?php } ?>

                    <?php if(isset($avitore_redux_demo['header_link_instagram'])){?>

                        <li><a href="<?php echo esc_url($avitore_redux_demo['header_link_instagram']);?>"><i class="fa fa-instagram"></i></a></li>

                    <?php } ?>

                    <?php if(isset($avitore_redux_demo['header_link_google'])){?>

                     <li><a href="<?php echo esc_url($avitore_redux_demo['header_link_google']);?>"><i class="fa fa-google-plus"></i></a></li>
