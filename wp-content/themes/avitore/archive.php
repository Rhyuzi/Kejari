    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-12 text-center">
          <h2 class="text-uppercase text-white mrb-10"><?php
              if ( is_day() ) :
                printf( esc_html__( 'Daily Archives: %s', 'avitore' ), get_the_date() );
                elseif ( is_month() ) :
                    printf( esc_html__( 'Monthly Archives: %s', 'avitore' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'avitore' ) ) );
                elseif ( is_year() ) :
                    printf( esc_html__( 'Yearly Archives: %s', 'avitore' ), get_the_date( _x( 'Y', 'yearly archives date format', 'avitore' ) ) );
                else :
                    echo esc_html__( 'Archives', 'avitore' );
                endif;
                ?></h2>
        </div>
      </div>
