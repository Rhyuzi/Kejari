...
<body <?php body_class('header-home-4'); ?>>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12 d-flex align-items-center justify-content-between">
            ...
            <div class="topbar-info-area d-none d-sm-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center mr-3">
                  ...
                  <div>
                    ...
                    <h6><?php echo htmlspecialchars_decode(esc_attr($avitore_redux_demo['header_email_title']));?></h6>

                    <a class="text-gray" href="<?php echo htmlspecialchars_decode(esc_attr($avitore_redux_demo['header_email_link']));?>"><?php echo htmlspecialchars_decode(esc_attr($avitore_redux_demo['header_email_subtitle']));?></a>
            ...
            <div class="d-none d-md-flex align-items-center">
              ...
              <div>
                ...
                <h6><?php echo htmlspecialchars_decode(esc_attr($avitore_redux_demo['header_phone_title']));?></h6>

                <a class="text-gray" href="<?php echo htmlspecialchars_decode(esc_attr($avitore_redux_demo['header_phone_link']));?>"> <?php echo htmlspecialchars_decode(esc_attr($avitore_redux_demo['header_phone_subtitle']));?></a>
        ...
        <div class="d-none d-lg-flex align-items-center ml-4">
          ...
          <a href="<?php echo esc_url($avitore_redux_demo['header_button_link']); ?>" class="cs-btn-one btn-primary-color"><?php echo htmlspecialchars_decode(esc_attr($avitore_redux_demo['header_button']));?></a>
    ...
    <?php }else{?>
        ...
        <div class="side-panel-logo mrb-30">
            ...
            <a href="<?php echo esc_url(home_url('/')); ?>">
                ...
                <img src="<?php echo get_template_directory_uri();?>/assets/img/logo-sidebar-dark.png" alt="" />
