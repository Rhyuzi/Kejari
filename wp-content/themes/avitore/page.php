...
<?php if(isset($avitore_redux_demo['blog_image']['url']) && $avitore_redux_demo['blog_image']['url'] != ''){?>
        <div class="breadcrumb-area breadcrumb-bg pt-260 pb-265" style="background-image:url(<?php echo esc_url($avitore_redux_demo['blog_image']['url']);?>)">
    <?php }else{?>     
                    ...
                    <div class="col-lg-8">
                        <article class="postbox post format-image mb-40">
                            ...
                            <div class="postbox__text bg-none">
                                ...
                                <?php if ( is_sticky() ) echo '<span class="featured-post">' . esc_html__( 'Sticky', 'avitore' ) . '</span>';?>
                                <div class="post-text mb-20 page-content">
                                    <?php the_content(); ?>
                                    <?php wp_link_pages( array(
                                    'before'      => '<div class="page-links">' . esc_html__( 'Pages:', 'avitore' ),
                                    'after'       => '</div>',
